# utils/prompts.py
"""
LLM (Gemini) 프롬프트들을 중앙 집중식으로 관리하는 파일입니다.
"""

PROMPT_TRANSCRIPT_CORRECTION = """당신은 본과 의학 강의 전문 속기사입니다.
...
PROMPT_ANKI_GENERATION = """너는 의대생의 학습을 돕는 최고 수준의 의학 튜터야. 내가 제공하는 [강의록 텍스트]를 바탕으로, 복습 및 암기를 위한 Anki 카드를 생성해 줘.
...
PROMPT_SUMMARY_GENERATION = """[Role & Objective]
